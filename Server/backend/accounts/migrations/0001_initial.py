    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("groups", models.JSONField(blank=True, default=list, null=True)),
                (
                    "profile_local_path",
                ...
                ("sessions", models.JSONField(blank=True, default=list, null=True)),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="accounts_lo_event_t_78dcaa_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="logentry",
            index=models.Index(
                fields=["user", "timestamp"], name="accounts_lo_user_id_b0379d_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="logentry",
            index=models.Index(
                fields=["client", "timestamp"], name="accounts_lo_client__a5903b_idx"
            ),
        ),
    ]
