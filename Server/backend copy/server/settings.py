...
# Allow OAuth2 token requests from any client (for now)
OAUTH2_VALIDATOR_CLASS = 'accounts.oauth_validators.BasicOAuthValidator'
...
OAUTH2_PROVIDER = {
    ...
    'OAUTH2_ACCESS_TOKEN_MODEL': 'accounts.models.OAuth2AccessToken',
    'SCOPES': {
        'read': 'Read access',
        'write': 'Write access',
    },
    'DEFAULT_SCOPES': ['read', 'write'],
    'ACCESS_TOKEN_EXPIRE_SECONDS': 3600,  # 1 hour expiry (optional)
}
