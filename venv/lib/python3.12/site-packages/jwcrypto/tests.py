...
Useofx5c = {
    ...
    "e": "AQAB",
    "x5c": [
        "MIIDQjCCAiqgAwIBAgIGATz/FuLiMA0GCSqGSIb3DQEBBQUAMGIxCzAJ"
...
PublicKeys_brainpool = {
    "keys": [
        ...
        },
        {
            ...
            "crv": "BP-384",
            "x": (
                "WZanneaC2Hi3xslA4znJv7otyEdV5dTPzNUvBjBXPM" "ytf4mRY9JaAITdItjvUTAh"
            ),
            "y": (
                "KNLRTNdvUg66aB_TVW4POZkE3q8S0YoQrCzYUrExRDe" "_BXikkqIama-GYQ3UBOQL"
            ),
        },
        {
            "kty": "EC",
            "crv": "BP-512",
            "x": (
                "aQXpvz7DH9OK5eFNO9dY3BdPY1v0-8Rg9KC322PY1Jy"
                "BJq3EhT0uR_-tgbL2E_aGP6k56lF1xIOOtQxo8zziGA"
            ),
            "y": (
                "l9XLHHncigOPr5Tvnj_mVzBFv6i7rdBQrLTq3RXZlCC"
...
PrivateKeys_brainpool = {
    "keys": [
        ...
        },
        {
            ...
            "d": (
                "B5WeRV0-RztAPAhRbphSAUrsIzy-eSfWGSM5FxOQGlJ" "cq-ECLA_-SIlH7NdWIEJY"
            ),
        },
        {
            "kty": "EC",
            ...
            "d": (
                "F_LJ9rebAjOtxoMUfngIywYsnJlZNjy3gxNAEvHjSkL"
...
class TestJWK(unittest.TestCase):
    ...
    def test_import_pyca_keys(self):
        ...
        self.assertEqual(
            krsa1.get_op_key("verify").public_numbers().n,
        ...
        self.assertEqual(
            kec1.get_op_key("verify").public_numbers().x,
            kec2.get_op_key("verify").public_numbers().x,
        )
        self.assertRaises(jwk.InvalidJWKValue, jwk.JWK.from_pyca, {})
    ...
    def test_thumbprint(self):
        for i in range(0, len(PublicKeys["keys"])):
            ...
            self.assertEqual(k.thumbprint(), PublicKeys["thumbprints"][i])
    ...
    def test_import_from_pem(self):
        ...
        self.assertEqual(
            rsapri.public_key().public_numbers().n, rsapub.public_numbers().n
        )
    ...
    def test_export_symmetric(self):
        ...
        self.assertEqual(json_encode(SymmetricKeys["keys"][0]), key.export_symmetric())
    ...
    def test_export_as_dict(self):
        ...
        self.assertEqual(k["kid"], "x31vrbZceU2qOPLtrUwPkLa3PNakMn9tOsq_ntFVrJc")
    ...
    def test_thumbprint_eddsa(self):
        for i in range(0, len(PublicKeys_EdDsa["keys"])):
            ...
            self.assertEqual(k.thumbprint(), PublicKeys_EdDsa["thumbprints"][i])
...
# RFC 7515 - A.2
A2_protected = [123, 34, 97, 108, 103, 34, 58, 34, 82, 83, 50, 53, 54, 34, 125]
...
# RFC 7515 - A.3
A3_protected = [123, 34, 97, 108, 103, 34, 58, 34, 69, 83, 50, 53, 54, 34, 125]
...
# RFC 7515 - A.4
A4_protected = [123, 34, 97, 108, 103, 34, 58, 34, 69, 83, 53, 49, 50, 34, 125]
...
A6_example = {
    ...
    "jose_header": [
        {"kid": "2010-12-29", "alg": "RS256"},
        {"kid": "e9bc097a-ce51-4036-9562-d2ade882db0d", "alg": "ES256"},
    ],
}
...
class TestJWS(unittest.TestCase):
    ...
    def test_A5(self):
        self.assertRaises(jws.InvalidJWSOperation, self.check_sign, A5_example)
    ...
    def test_A6(self):
        ...
        s.add_signature(
            A6_example["key1"], None, A6_example["protected1"], A6_example["header1"]
        )
        s.add_signature(
            A6_example["key2"], None, A6_example["protected2"], A6_example["header2"]
        )
    ...
    def test_EdDsa_signing_and_verification(self):
        ...
        for curve_example in examples:
            ...
            jws_test.add_signature(key, None, json_encode(protected_header), None)
            ...
            self.assertEqual(
                jws_verify.payload.decode("utf-8"), curve_example["payload"]
            )
    ...
    def test_jws_issue_281(self):
        ...
        s.add_signature(key, protected=header, header={"kid": key.thumbprint()})
...
Issue_136_Protected_Header_no_epk = {"alg": "ECDH-ES+A256KW", "enc": "A256CBC-HS512"}
...
X25519_Protected_Header_no_epk = {"alg": "ECDH-ES+A128KW", "enc": "A128GCM"}
...
class TestJWE(unittest.TestCase):
    ...
    def test_A4(self):
        e = jwe.JWE(
            E_A4_ex["plaintext"], E_A4_ex["protected"], algs=jwe_algs_and_rsa1_5
        )
    ...
    def test_JWE_Issue_136(self):
        ...
        e = jwe.JWE()
        e.deserialize(Issue_136_Contributed_JWE, jwk.JWK(**Issue_136_Contributed_Key))
...
# RFC 7519
A1_header = {"alg": "RSA1_5", "enc": "A128CBC-HS256"}

A1_claims = {"iss": "joe", "exp": 1300819380, "http://example.com/is_root": True}
...
class TestJWT(unittest.TestCase):
    ...
    def test_A1(self):
        ...
        t = jwt.JWT(A1_header, A1_claims, algs=jwe_algs_and_rsa1_5)
        t.make_encrypted_token(key)
        token = t.serialize()
        t.deserialize(token)
        # then try the test vector
        t = jwt.JWT(jwt=A1_token, key=key, check_claims=False, algs=jwe_algs_and_rsa1_5)
        ...
        self.assertRaises(
            jwt.JWTExpired, jwt.JWT, jwt=A1_token, key=key, algs=jwe_algs_and_rsa1_5
        )

    def test_A2(self):
        sigkey = jwk.JWK(**A2_example["key"])
        touter = jwt.JWT(jwt=A2_token, key=E_A2_ex["key"], algs=jwe_algs_and_rsa1_5)
    ...
    def test_decrypt_keyset(self):
        ...
        token = t.serialize()
        self.assertRaises(
            jwt.JWTMissingKey, jwt.JWT, jwt=token, key=keyset, algs=jwe_algs_and_rsa1_5
        )
    ...
    def test_claim_params(self):
        ...
        jwt.JWT(
            ...
            key=key,
            algs=jwe_algs_and_rsa1_5,
            check_claims={"iss": "test", "exp": None, "string_claim": "test"},
        )
    ...
    def test_claims_typ(self):
        ...
        self.assertRaises(
            ...
            jwt=token,
            key=key,
            check_claims={"typ": "application/wrong"},
        )
        ...
        self.assertRaises(
            ...
            jwt=token,
            key=key,
            check_claims={"typ": "application/test"},
        )
        self.assertRaises(
            jwt.JWTInvalidClaimValue,
            jwt.JWT,
    ...
    def test_Issue_277(self):
        ...
        jwt.JWT(
            key=key,
            jwt=sertok,
            check_claims={"aud": ["www.example.com", "www.test.net"]},
        )
        jwt.JWT(
            key=key, jwt=sertok, check_claims={"aud": ["www.example.com", "nomatch"]}
        )
        self.assertRaises(
            jwt.JWTInvalidClaimValue,
            jwt.JWT,
        ...
        self.assertRaises(
            ...
            key=key,
            jwt=sertok,
            check_claims={"aud": ["nomatch", "failmatch"]},
        )
    ...
    def test_unexpected(self):
        ...
        token = jwt.JWT(header={"alg": "A256KW", "enc": "A256GCM"}, claims=claims)
...
class ConformanceTests(unittest.TestCase):
    ...
    def test_key_ops_values(self):
        self.assertRaises(
            jwk.InvalidJWKValue, jwk.JWK, kty="RSA", n=1, key_ops=["sign"], use="enc"
        )
        self.assertRaises(
            jwk.InvalidJWKValue, jwk.JWK, kty="RSA", n=1, key_ops=["sign", "sign"]
        )
    ...
    def test_jws_loopback(self):
        ...
        sign.add_signature(
            jwk.JWK(kty="oct", k=base64url_encode(b"A" * 16)), alg="HS512"
        )
        o = sign.serialize()
        check = jws.JWS()
        check.deserialize(
            o, jwk.JWK(kty="oct", k=base64url_encode(b"A" * 16)), alg="HS512"
        )
    ...
    def test_jws_headers_as_dicts(self):
        ...
        sign.add_signature(
            key, protected={"alg": "HS512"}, header={"kid": key.thumbprint()}
        )
        o = sign.serialize()
        check = jws.JWS()
    ...
    def test_jwe_headers_as_dicts(self):
        enc = jwe.JWE(
            plaintext="message", protected={"alg": "A256KW", "enc": "A256CBC-HS512"}
        )
        ...
        self.assertEqual(json_decode(check.objects["header"])["kid"], key.thumbprint())
    ...
    def test_no_default_rsa_1_5(self):
        s = jws.JWS("test")
        with self.assertRaisesRegex(jws.InvalidJWSOperation, "Algorithm not allowed"):
            s.add_signature(A2_key, alg="RSA1_5")

    def test_pbes2_hs256_aeskw(self):
        enc = jwe.JWE(
            plaintext="plain",
            protected={"alg": "PBES2-HS256+A128KW", "enc": "A256CBC-HS512"},
        )
    ...
    def test_jwe_decompression_max(self):
        ...
        enc = jwe.JWE(
            payload.encode("utf-8"), recipient=key, protected=protected_header
...
class TestUnencodedPayload(unittest.TestCase):
    ...
    def test_regular(self):
        ...
        s.add_signature(jwk.JWK(**SymmetricKeys["keys"][1]), protected=rfc7797_e_header)
    ...
    def test_compat_unencoded(self):
        ...
        s = jws.JWS(rfc7797_payload)
        s.add_signature(jwk.JWK(**SymmetricKeys["keys"][1]), protected=rfc7797_u_header)
    ...
    def test_detached_payload_verification(self):
        ...
        s = jws.JWS()
        s.deserialize(token)
        s.verify(jwk.JWK(**SymmetricKeys["keys"][1]), detached_payload=rfc7797_payload)
    ...
    def test_misses_crit(self):
        ...
        with self.assertRaises(jws.InvalidJWSObject):
            s.add_signature(
                jwk.JWK(**SymmetricKeys["keys"][1]),
                protected={"alg": "HS256", "b64": False},
            )

    def test_mismatching_encoding(self):
        s = jws.JWS(rfc7797_payload)
        s.add_signature(jwk.JWK(**SymmetricKeys["keys"][0]), protected=rfc7797_e_header)
        with self.assertRaises(jws.InvalidJWSObject):
            s.add_signature(
                jwk.JWK(**SymmetricKeys["keys"][1]), protected=rfc7797_u_header
            )
...
class TestOverloadedOperators(unittest.TestCase):
    ...
    def test_jws_representations(self):
        ...
        self.assertEqual(str(token), "JWS(payload=My Integrity protected message)")
        self.assertEqual(repr(token), "JWS(payload=My Integrity protected message)")
        token.add_signature(
            key,
            None,
            json_encode({"alg": "HS256"}),
    ...
    def test_jwt_equality(self):
        key = jwk.JWK.generate(kty="oct", size=256)
        signer_a = jwt.JWT(
            header={"alg": "HS256"}, claims={"info": "I'm a signed token"}
        )
        signer_b = jwt.JWT(
            header={"alg": "HS256"}, claims={"info": "I'm a signed token"}
        )
