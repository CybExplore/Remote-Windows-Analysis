            ...
            (
                ...
                (
                    ...
                    self.gf("django.db.models.fields.CharField")(
                        default="37b581bdc702c732aa65", max_length=255
                    ),
                ),
                (
                    "client_secret",
                    self.gf("django.db.models.fields.CharField")(
                        default="5cf90561f7566aa81457f8a32187dcb8147c7b73",
                        max_length=255,
                    ),
                ),
        ...
        db.create_table(
            ...
            (
                ...
                (
                    "client",
                    self.gf("django.db.models.fields.related.ForeignKey")(
                        to=orm["oauth2.Client"]
                    ),
                ),
                (
                    "code",
                    self.gf("django.db.models.fields.CharField")(
                        default="f0cda1a5f4ae915431ff93f477c012b38e2429c4",
                        max_length=255,
                    ),
                ),
                (
                    ...
                    self.gf("django.db.models.fields.DateTimeField")(
                        default=datetime.datetime(2012, 2, 8, 10, 43, 45, 620301)
                    ),
                ),
                (
                    "redirect_uri",
        ...
        db.create_table(
            ...
            (
                ...
                (
                    "token",
                    self.gf("django.db.models.fields.CharField")(
                        default="b10b8f721e95117cb13c", max_length=255
                    ),
                ),
                (
                    "client",
                ...
                (
                    "expires",
                    self.gf("django.db.models.fields.DateTimeField")(
                        default=datetime.datetime(2013, 2, 7, 10, 33, 45, 618854)
                    ),
                ),
                ("scope", self.gf("django.db.models.fields.IntegerField")(default=0)),
            ),
    ...
    models = {
        ...
        "oauth2.accesstoken": {
            ...
            "expires": (
                "django.db.models.fields.DateTimeField",
                [],
                {"default": "datetime.datetime(2013, 2, 7, 10, 33, 45, 624553)"},
            ),
            "id": ("django.db.models.fields.AutoField", [], {"primary_key": "True"}),
            ...
            "token": (
                "django.db.models.fields.CharField",
                [],
                {"default": "'d5c1f65020ebdc89f20c'", "max_length": "255"},
            ),
            "user": (
                "django.db.models.fields.related.ForeignKey",
                [],
        ...
        "oauth2.client": {
            ...
            "client_id": (
                "django.db.models.fields.CharField",
                [],
                {"default": "'306fb26cbcc87dd33cdb'", "max_length": "255"},
            ),
            "client_secret": (
                "django.db.models.fields.CharField",
                [],
        ...
        "oauth2.grant": {
            ...
            "code": (
                ...
                [],
                {
                    "default": "'310b2c63e27306ecf5307569dd62340cc4994b73'",
                    "max_length": "255",
                },
            ),
            "expires": (
                "django.db.models.fields.DateTimeField",
                [],
                {"default": "datetime.datetime(2012, 2, 8, 10, 43, 45, 625956)"},
            ),
            "id": ("django.db.models.fields.AutoField", [], {"primary_key": "True"}),
            "redirect_uri": (
                "django.db.models.fields.CharField",
        ...
        "oauth2.refreshtoken": {
            ...
            "token": (
                ...
                [],
                {
                    "default": "'ef0ab76037f17769ab2975a816e8f41a1c11d25e'",
                    "max_length": "255",
                },
            ),
            "user": (
